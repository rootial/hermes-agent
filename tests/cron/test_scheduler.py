...
class TestRunJobSessionPersistence:
    ...
    def test_run_job_passes_model_max_tokens_from_config(self, tmp_path):
        job = {
            "id": "max-tokens-job",
            "name": "test",
            "prompt": "hello",
    ...
    def test_run_job_prefers_per_job_max_tokens_over_config(self, tmp_path):
        job = {
            "id": "job-max-tokens-job",
            "name": "test",
            "prompt": "hello",
            "max_tokens": 512,
        }
