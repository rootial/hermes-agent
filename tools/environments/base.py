...
class BaseEnvironment(ABC):
    ...
    def init_session(self):
        ...
        #
        # mktemp provides a unique same-directory file on every supported Bash,
        # including macOS Bash 3.2 where BASHPID is unavailable.
    ...
    def _wrap_command(self, command: str, cwd: str) -> str:
        ...
        # truncated/half-written file. mktemp supplies a unique same-directory
        # path on Linux, macOS Bash 3.2, and Git Bash.
        _snap_tmp_template = shlex.quote(self._snapshot_path + ".tmp.XXXXXX")
        ...
        if self._snapshot_ready:
            parts.append(
                ...
                f"2>/dev/null || rm -f \"$__hermes_snap_tmp\" 2>/dev/null || true; fi"
            )
